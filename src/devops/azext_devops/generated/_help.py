...
helps['devops pipeline create'] = """
    ...
    examples:
      - name: Create an Azure pipeline to deploy a sample ASP.Net application to Azure web-app
        text: |-
               az devops pipeline create --location "South India" --bootstrap-configuration "{\\"template\\":{\\"id\\":\
\\"ms.vss-continuous-delivery-pipeline-templates.aspnet-windowswebapp\\",\\"parameters\\":{\\"appInsightLocation\\":\\"\
South India\\",\\"appServicePlan\\":\\"S1 Standard\\",\\"azureAuth\\":\\"{\\\\\\"scheme\\\\\\":\\\\\\"ServicePrincipal\
\\\\\\",\\\\\\"parameters\\\\\\":{\\\\\\"tenantid\\\\\\":\\\\\\"{subscriptionTenantId}\\\\\\",\\\\\\"objectid\\\\\\":\\\
\\\\"{appObjectId}\\\\\\",\\\\\\"serviceprincipalid\\\\\\":\\\\\\"{appId}\\\\\\",\\\\\\"serviceprincipalkey\\\\\\":\\\\\
\\"{appSecret}\\\\\\"}}\\",\\"location\\":\\"South India\\",\\"resourceGroup\\":\\"myAspNetWebAppPipeline-rg\\",\\"subs\
criptionId\\":\\"{subscriptionId}\\",\\"webAppName\\":\\"myAspNetWebApp\\"}}}" --organization name=myAspNetWebAppPipeli\
ne-org --project name=myAspNetWebAppPipeline-project --pipeline-name "myAspNetWebAppPipeline" --resource-group "myAspNe\
tWebAppPipeline-rg"
"""
