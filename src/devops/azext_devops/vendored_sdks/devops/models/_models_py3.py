...
class CloudError(msrest.serialization.Model):
    ...
    :type error: ~azure_dev_ops.models.CloudErrorBody
    """
...
class CodeRepository(msrest.serialization.Model):
    """Repository containing the source code for a pipeline.

    All required parameters must be populated in order to send to Azure.

    :param repository_type: Required. Type of code repository. Possible values include: 'gitHub',
     'vstsGit'.
    ...
    :type id: str
    :param default_branch: Required. Default branch used to configure Continuous Integration (CI)
     in the pipeline.
    :type default_branch: str
    :param authorization: Authorization info to access the code repository.
    :type authorization: ~azure_dev_ops.models.Authorization
    ...
    def __init__(
        self,
        *,
        repository_type: Union[str, "CodeRepositoryType"],
        id: str,
        default_branch: str,
...
class Pipeline(Resource):
    ...
    :param bootstrap_configuration: Required. Configuration used to bootstrap the Pipeline.
...
class PipelineTemplate(msrest.serialization.Model):
